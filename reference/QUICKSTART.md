# SecOpsMonitor Quick Start Guide

Get SecOpsMonitor running in 5 minutes for your first network assessment.
...
```bash
# 1. Start SecOpsMonitor on your laptop
npm run dev

# 2. Connect to network SPAN port or TAP
# 3. Open SecOpsMonitor: http://localhost:5174
