# SecOpsMonitor v0.9.2-alpha Release Notes

## 🎉 What's New in v0.9.2

SecOpsMonitor v0.9.2 introduces **7 major new features** for advanced threat detection, investigation workflows, and real-time analysis. All features integrate seamlessly with the existing passive ICS/SCADA discovery platform.
...
Real-time monitoring of SecOpsMonitor system health and operational metrics.
