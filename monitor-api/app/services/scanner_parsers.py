"""
Scanner result parsers for importing security findings into SecOpsMonitor.
...
def parse_semgrep(data: dict[str, Any]) -> list[dict[str, Any]]:
    """Parse Semgrep JSON output into SecOpsMonitor object format."""
    results = []
...
def parse_trivy(data: dict[str, Any]) -> list[dict[str, Any]]:
    """Parse Trivy JSON output into SecOpsMonitor object format."""
    results = []
...
def parse_sarif(data: dict[str, Any]) -> list[dict[str, Any]]:
    """Parse SARIF v2.1.0 JSON output into SecOpsMonitor object format."""
    results = []
...
def parse_generic(data: dict[str, Any]) -> list[dict[str, Any]]:
    """Parse a generic JSON format into SecOpsMonitor object format.
