...
def generate_report(
    ...
    if WEASYPRINT_AVAILABLE:
        filename = f"secopsmonitor_{session_name}_{timestamp}.pdf"
    ...
    # Fallback to HTML
    filename = f"secopsmonitor_{session_name}_{timestamp}.html"
    filepath = REPORTS_DIR / filename
...
<head>
    <meta charset="UTF-8">
    <title>SecOpsMonitor Assessment Report</title>
    <style>
...
<body>
    ...
    SecOpsMonitor analyzed network traffic to identify devices, map communications, and detect security risks
    ...
    <div class="footer">
        Generated by SecOpsMonitor v0.9.2 — Passive ICS/SCADA Network Discovery &amp; Topology Visualization<br>
