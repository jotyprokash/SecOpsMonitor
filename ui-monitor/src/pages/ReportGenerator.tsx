...
export default function ReportGenerator() {
  ...
  const handleGenerate = () => {
    ...
    setTimeout(() => {
      ...
      handleDownload('SecOpsMonitor_Sample_Assessment');
    }, 2000);
  };

  const handleDownload = (_name: string) => {
    // Download sample HTML report (generated by monitor-api engine with real data)
    const a = document.createElement('a');
    a.href = `${import.meta.env.BASE_URL}sample-report.html`;
    a.download = 'SecOpsMonitor_ICS_Assessment_Report.html';
        ...
        <div className="col-span-2 space-y-4">
          <div className="rounded-lg border border-border-default bg-surface-card overflow-hidden">
            <div className="bg-bg-secondary p-6 text-center border-b border-border-default relative">
              ...
              <p className="text-lg font-bold text-content-primary">SecOpsMonitor</p>
