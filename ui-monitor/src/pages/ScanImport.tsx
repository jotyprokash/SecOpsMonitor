    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-content-secondary">Import PCAP captures, external tool outputs, and scan results into SecOpsMonitor</p>
        </div>
      </div>
      ...
      <Tabs defaultValue="pcap">
        ...
        <TabPanel value="tools">
          <div className="grid grid-cols-2 gap-4">
            ...
            <ToolCard
              name="Wireshark"
              description="Open the currently loaded PCAP in Wireshark for deep packet inspection. Requires the SecOpsMonitor desktop agent."
