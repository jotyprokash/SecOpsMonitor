...
export default function ExportHub() {
  ...
  const handleJsonExport = () => {
    ...
    triggerBlobDownload('secopsmonitor_session_export.json', mockJson, 'application/json');
  };
  ...
  const handleSbomExport = () => {
    ...
    triggerBlobDownload('secopsmonitor_sbom.json', mockSbom, 'application/json');
  };
  ...
  const handleStixExport = () => {
    const mockStix = JSON.stringify({
      ...
      spec_version: '2.1',
      objects: [
        { type: 'identity', id: 'identity--secopsmonitor', name: 'SecOpsMonitor ICS Discovery', identity_class: 'system' },
        { type: 'infrastructure', id: 'infrastructure--plant-ot', name: 'Acme Plant OT Network', infrastructure_types: ['industrial-control-system'] },
      ],
    }, null, 2);
    triggerBlobDownload('secopsmonitor_stix_bundle.json', mockStix, 'application/json');
  };
  ...
  const handleRemediationExport = () => {
    ...
    triggerBlobDownload('secopsmonitor_remediation_priority.csv', header + rows, 'text/csv');
  };
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              onClick={() => triggerBlobDownload(
                `secopsmonitor_allowlist_${fwFormat}.txt`,
